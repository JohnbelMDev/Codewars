...
//  2. Because I'm passing an intenger and multiply  a number by itself. It's safe for me that I will be returning a number of type INT
...
//       2: convert the numbers to int incase someone pass an integer
 let NumIntenger;
  NumIntenger = parseInt(i) + parseInt( i);
